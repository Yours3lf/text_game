...
public:
  ...
  void set_start_scale( const vec3& s )
  {
    start_scale = s;
  }

  void set_end_scale( const vec3& s )
  {
    end_scale = s;
  }

  void set_start_pos( const vec3& p )
  {
    start_pos = p;
  }

  void set_end_pos( const vec3& p )
  {
    end_pos = p;
  }
  ...
  void set_highlight_color( const vec4& color )
  {
