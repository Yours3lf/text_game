...
class font
{
  ...
  public:
    ...
    mm::vec2 add_to_render_list( const std::wstring& text, font_inst& font_ptr, mm::vec4 color = mm::vec4( 1 ), mm::mat4 mat = mm::mat4::identity, mm::vec4 highlight_color = mm::vec4( 1 ), float line_height = 1, float filter = 0 );
    void render();
